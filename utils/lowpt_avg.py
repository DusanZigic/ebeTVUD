...
class lowpTAvg:
    def __init__(self, multiplicityFiles, multiplicityOutFile, qnFiles, vnOutFile):
        self.multiplicityFiles = multiplicityFiles
        self.multiplicityOutFile = multiplicityOutFile
        self.qnFiles = qnFiles
        self.vnOutFile = vnOutFile

    def calculate_mult(self):
        export_file = open(self.multiplicityOutFile, 'w')
        particles = []
        with open(self.multiplicityFiles[0], 'r') as f:
            while True:
    ...
    def calculate_vn(self):
        ...
        export_file = open(self.vnOutFile, 'w')
        ...
        for ipt in range(len(dQ[2])):
            ...
            ptval = 0.3 + ipt * 0.2
            print(f"{ptval:.3f} {v22:.4f} {v22err:.4f} {v24:.4f} {v24err:.4f} {v32:.4f} {v32err:.4f} {v34:.4f} {v34err:.4f} {v42:.4f} {v42err:.4f} {v44:.4f} {v44err:.4f}", file=export_file)
